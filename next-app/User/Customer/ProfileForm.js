...
export default function CustomerProfileForm({ classes }) {
	...
	const [apartment, changeApartment] = useState("");
	...
	return (
		...
		>
			...
			<FormGroup>
				<div>
					<TextField label="First Name" value="Anh"></TextField>
					<TextField label="Last Name" value="Nguyen"></TextField>
				</div>
			</FormGroup>
			{/*  Profile sensitive group */}
			<FormGroup>
				{/* Date of birth group */}
			...
			<FormGroup>
				...
				<div>
					<TextField
						onChange={(e) => changeStateProvince(e.target.value)}
						label="State or Province"
						value={stateProvince}
						id="profile_state_province"
					></TextField>
					<TextField
						required
			...
			<FormGroup>
				<Button
					...
					variant="contained"
					size="large"
					className={clsx(classes.margin, classes.updateProfileButton)}
				>
					Update Profile
				</Button>
			</FormGroup>
